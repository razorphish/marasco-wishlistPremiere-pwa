...
var LoginComponent = /** @class */ (function () {
    ...
    //   ) {
    function LoginComponent(_store, _pwaService) {
        var _this = this;
        this._store = _store;
    ...
    LoginComponent.prototype.login = function ($event) {
        ...
        this['settings'].store.dispatch(new _app_features_marasco_core_store_auth__WEBPACK_IMPORTED_MODULE_2__["LoginAction"](model));
    };
